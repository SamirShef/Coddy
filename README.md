# Coddy
`Coddy` - универсальный, высокоуровневый, интерпритируемый, статически типизированный язык программирования, созданный с опорой на синтаксис `Python`, `C++` и других языков. `Coddy` написан на высокоуровневом языке программирования `C#` с использованием нейросети `DeepSeek`.
...
> [!IMPORTANT]
> Функции могут быть вызваны только позже их непосредственного объявления.
