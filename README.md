...
# Импорт библиотек
Импорт библиотек осуществляется с помощью ключевого слова include и строкового литерала пути к библиотечному файлу. Считываются только классы из библиотечного файла.
