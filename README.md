...
# ООП (неполное)
`Coddy` поддерживает неполную систему ООП, а именно: [классы](#классы), [поля/методы классов](#поля-и-методы), [контекст `this`](#контекст-this), [конструкторы](#конструкторы), [создание экземпляров классов](#экземпляры), [вызов полей/методов из экземпляров](#вызовы-членов-класса), [статика](#статика), [интерфейсы](#интерфейсы), [наследование](#наследование).
