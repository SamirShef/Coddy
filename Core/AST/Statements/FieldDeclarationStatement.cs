...
public class FieldDeclarationStatement(string name, List<string> typeExpressions, AccessModifier access, IExpression? expression, List<string> modifiers, bool hasGetter, bool hasSetter) : IStatement
{
